...
<?php $page='deanhome-rs'; include 'menu.php';  ?>


<div class="pcoded-content">                         
<form class="panel-body form-horizontal form-padding" name="reinfor" action="deanhome-rs.php" method ="post"enctype="multipart/form-data">                    
