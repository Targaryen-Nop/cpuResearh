...
<head>
    <title>CPU RESEARCH | อัพเดทสถานะโครงการวิจัย</title>
    <meta charset="utf-8">
...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="deandatastatuss-rs.php" method ="post"enctype="multipart/form-data">                    
     <!-- Page-header end -->
