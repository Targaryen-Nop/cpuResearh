                       ...
                       ?></div>  
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              <li class="nav-item <?php if($page=='dashboard-rs'){echo 'active';} ?>">
                                    <a href="/rs-cpu/dean/science/dashboard-rs.php" class="waves-effect waves-dark">
                              ...
                              <li class="nav-item <?php if($page=='profile-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/science/profile-rs.php" class="waves-effect waves-dark">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                                  <li class="nav-item <?php if($page=='deanhome1-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/science/deanhome1-rs.php" class="waves-effect waves-dark ">
                                  ...
                                  <li class="nav-item <?php if($page=='deanhome-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/science/deanhome-rs.php" class="waves-effect waves-dark ">
                         ...
                         <div class="pcoded-navigation-label" data-i18n="nav.category.forms">โครงการวิจัย</div>
                          <ul class="pcoded-item pcoded-left-item">
                                  <li class="nav-item <?php if($page=='deandata-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/science/deandata-rs.php" class="waves-effect waves-dark ">
                              ...
                              <ul class="pcoded-item pcoded-left-item">
                                   <li class="nav-item <?php if($page=='deanpublish-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/science/deanpublish-rs.php" class="waves-effect waves-dark ">
                                   ...
                                   <li class="nav-item <?php if($page=='deanpublishscore-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/science/deanpublishscore-rs.php" class="waves-effect waves-dark ">
                                      <span class="pcoded-micon"><i class="ti-bookmark-alt"></i><b></b></span>
                              ...
                              <ul class="pcoded-item pcoded-left-item">
                                   <li class="nav-item <?php if($page=='deanbudget-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/science/deanbudget-rs.php" class="waves-effect waves-dark ">
                                      <span class="pcoded-micon"><i class="ti-bookmark-alt"></i><b></b></span>
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                                  <li class="nav-item <?php if($page=='deandbrs-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/science/deandbrs-rs.php" class="waves-effect waves-dark ">
                                   ...
                                   <li class="nav-item <?php if($page=='deandbpbrs-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/science/deandbpbrs-rs.php" class="waves-effect waves-dark ">
                                      <span class="pcoded-micon"><i class="ti-folder"></i><b></b></span>
