...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="deandata-rs.php" method ="post"enctype="multipart/form-data">                    
                    ...
                    <div class="sub-title">
                       ...
                       <ul class="nav nav-tabs  tabs" role="tablist">
                        <li class="nav-item">
                        <a class="nav-link active " data-toggle="tab" href="#t1" role="tab">คณะวิทยาศาสตร์และเทคโนโลยี</a>
                        </li>

                        <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#t2" role="tab">สาขาวิชาวิทยาการคอมพิวเตอร์</a>
                        </li>

                        <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#t3" role="tab">สาขาวิชาคอมพิวเตอร์มัลติมีเดีย</a>
                        </li>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green">
                                             <?php 
$sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาวิทยาการคอมพิวเตอร์'" ;
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-blue">
                                             <?php 
  $sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาวิทยาการคอมพิวเตอร์'and statusinformation_rs = 'อยู่ระหว่างพิจารณา'";
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-yellow">
                                             <?php 
  $sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาวิทยาการคอมพิวเตอร์' and statusinformation_rs = 'อนุมัติโครงการ'";
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green">
                                             <?php 
    $sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาวิทยาการคอมพิวเตอร์' and statusinformation_rs = 'เสร็จสมบูรณ์'";
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?> 
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-red">
                                             <?php 
  $sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาวิทยาการคอมพิวเตอร์' and statusinformation_rs = 'ยกเลิกโครงการ'";
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?> 
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green">
                                             <?php 
$sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาคอมพิวเตอร์มัลติมีเดีย'" ;
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-blue">
                                             <?php 
  $sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาคอมพิวเตอร์มัลติมีเดีย'and statusinformation_rs = 'อยู่ระหว่างพิจารณา'";
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-yellow">
                                             <?php 
  $sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาคอมพิวเตอร์มัลติมีเดีย' and statusinformation_rs = 'อนุมัติโครงการ'";
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green">
                                             <?php 
    $sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาคอมพิวเตอร์มัลติมีเดีย' and statusinformation_rs = 'เสร็จสมบูรณ์'";
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?> 
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-red">
                                             <?php 
  $sql="SELECT*FROM rs_information where board_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี' and subject_rs = 'หลักสูตรวิทยาศาสตรบัณฑิต สาขาวิชาคอมพิวเตอร์มัลติมีเดีย' and statusinformation_rs = 'ยกเลิกโครงการ'";                                                    
                                             $result=mysqli_query($conn,$sql);
                                             $num_rows = mysqli_num_rows($result);  
                                                echo $num_rows;
                                             ?> 
...
<a class="dropdown-item waves-light waves-effect" href="/rs-cpu/dean/science/deandatashow-rs.php?id=<?php echo $row["id"];?>">รายละเอียดโครงร่างงานวิจัย</a>

                    <div class="dropdown-divider"></div>
<a class="dropdown-item waves-light waves-effect" href="/rs-cpu/dean/science/deandatastatus-rs.php?id=<?php echo $row["id"];?>">อัพเดทสถานะโครงการวิจัย</a>
                </div>
                </div>
                </div>            
           <?php        
           ...
           <!-- endTab 6 -->
            ...
            <table id="myTable3" class="display" style="width: 100%;">
                        ...
                        <?php
                             ...
                             $sql="SELECT*FROM rs_tracking where boardtk_rs = 'คณะวิทยาศาสตร์และเทคโนโลยี'" ;
                             $result=mysqli_query($conn,$sql);
                             while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
                        {?>
                <tr style="color:#000;">
 ...
 <a href="/rs-cpu/dean/science/deandatareporttracking-rs.php?id=<?php echo $row["id"];?>" class="btn btn-success btn-round waves-effect waves-light">ดูรายงาน</a></h3></td>
                    <?php
                    }?>
                        </tbody>
                        </table>
