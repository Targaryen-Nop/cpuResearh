           ...
           <div class="card-block">
                  ...
                  <?php
                        ...
                        <tr>
                             ...
                             <th class="h6 mb-2 ">สาขาวิชาการบริหารการศึกษา</th>  
                            <th class="h6 mb-2 ">รวม</th>  
                          ...
                          while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
                        {
                              ...
                              $totalm = $cma_rs + $law_rs + $pad_rs + $tp_rs + $moe_rs;
...
<div class="card">
<div class="card-header">
<h5>งบประมาณโครงการวิจัยคณะมนุษยศาสตร์และสังคมศาสตร์</h5>
</div>
 <div class="card-block">
     <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
            ...
            google.charts.setOnLoadCallback(drawChart); 
                            ...
                            var data = google.visualization.arrayToDataTable([
                             ['ปีการศึกษา','คณะมนุษยศาสตร์และสังคมศาสตร์'],
                             <?php
     ...
     <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
            ...
            google.charts.setOnLoadCallback(drawChart); 
                            ...
                            function drawChart() {
                            var data = google.visualization.arrayToDataTable([
    ['ปีการศึกษา','การโฆษณาและการประชาสัมพันธ์','นิติศาสตร์','รัฐประศาสนศาสตร์','ประกาศนียบัตรบัณฑิตวิชาชีพครู','การบริหารการศึกษา'],
                             <?php
                                ...
                                while ($data=mysqli_fetch_array($res)) {
                                   $yearcr_rs = $data['yearcr_rs'];
                                    ...
                                    $dop_rs = $data['dop_rs'];
                                   ?>
   ['<?php echo $yearcr_rs;?>',<?php echo $cma_rs;?>,<?php echo $law_rs;?>,<?php echo $pad_rs;?>,<?php echo $tp_rs;?>,<?php echo $moe_rs;?>],
                                    <?php
                                }
                             ?>
                            ]);
