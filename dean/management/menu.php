                       ...
                       ?></div>  
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              <li class="nav-item <?php if($page=='dashboard-rs'){echo 'active';} ?>">
                                    <a href="/rs-cpu/dean/management/dashboard-rs.php" class="waves-effect waves-dark">
                              ...
                              <li class="nav-item <?php if($page=='profile-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/management/profile-rs.php" class="waves-effect waves-dark">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                                  <li class="nav-item <?php if($page=='deanhome1-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/management/deanhome1-rs.php" class="waves-effect waves-dark ">
                                  ...
                                  <li class="nav-item <?php if($page=='deanhome-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/management/deanhome-rs.php" class="waves-effect waves-dark ">
                         ...
                         <div class="pcoded-navigation-label" data-i18n="nav.category.forms">โครงการวิจัย</div>
                          <ul class="pcoded-item pcoded-left-item">
                                  <li class="nav-item <?php if($page=='deandata-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/management/deandata-rs.php" class="waves-effect waves-dark ">
                              ...
                              <ul class="pcoded-item pcoded-left-item">
                                   <li class="nav-item <?php if($page=='deanpublish-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/management/deanpublish-rs.php" class="waves-effect waves-dark ">
                                   ...
                                   <li class="nav-item <?php if($page=='deanpublishscore-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/management/deanpublishscore-rs.php" class="waves-effect waves-dark ">
                                      <span class="pcoded-micon"><i class="ti-bookmark-alt"></i><b></b></span>
                              ...
                              <ul class="pcoded-item pcoded-left-item">
                                   <li class="nav-item <?php if($page=='deanbudget-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/management/deanbudget-rs.php" class="waves-effect waves-dark ">
                                      <span class="pcoded-micon"><i class="ti-bookmark-alt"></i><b></b></span>
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                                  <li class="nav-item <?php if($page=='deandbrs-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/management/deandbrs-rs.php" class="waves-effect waves-dark ">
                                   ...
                                   <li class="nav-item <?php if($page=='deandbpbrs-rs'){echo 'active';} ?>">
                                      <a href="/rs-cpu/dean/management/deandbpbrs-rs.php" class="waves-effect waves-dark ">
                                      <span class="pcoded-micon"><i class="ti-folder"></i><b></b></span>
