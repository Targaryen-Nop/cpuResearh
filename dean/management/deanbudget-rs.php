...
<div class="card">
<div class="card-header">
<h5>งบประมาณโครงการวิจัยคณะบริหารและการจัดการ</h5>
</div>
 <div class="card-block">
     <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
            ...
            google.charts.setOnLoadCallback(drawChart); 
                            ...
                            var data = google.visualization.arrayToDataTable([
                             ['ปีการศึกษา','คณะบริหารและการจัดการ'],
                             <?php
     ...
     <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
            ...
            google.charts.setOnLoadCallback(drawChart); 
                            ...
                            function drawChart() {
                            var data = google.visualization.arrayToDataTable([
    ['ปีการศึกษา','สาขาวิชาการจัดการ','สาขาวิชาการตลาด','สาขาวิชาการบัญชี','สาขาวิชาคอมพิวเตอร์ธุรกิจ','สาขาวิชาการโรงแรมและการท่องเที่ยว','สาขาวิชาการจัดการนวัตกรรมการค้า','สาขาวิชาการบริหารการพัฒนาองค์การ'],
                             <?php
                                ...
                                while ($data=mysqli_fetch_array($res)) {
                                   $yearcr_rs = $data['yearcr_rs'];
                                    ...
                                    $dop_rs = $data['dop_rs'];
                                   ?>
   ['<?php echo $yearcr_rs;?>',<?php echo $mgt_re;?>,<?php echo $mak_rs;?>,<?php echo $acc_rs;?>,<?php echo $bco_rs;?>,<?php echo $htm_rs;?>,<?php echo $cpa_rs;?>,<?php echo $dop_rs;?>],
                                    <?php
                                }
                             ?>
                            ]);
          ...
          height: 600,
          colors: ['#4D68FE', '#FFB012', '#E40505', '#D4166C', '#EC3305', '#FA4316', '#FC8C70']
        };
