...
<head>
    <title>CPU RESEARCH | โครงร่างงานวิจัย</title>
    <meta charset="utf-8">
...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="deandatashow-rs.php" method ="post"enctype="multipart/form-data">                    
                ...
                <form>
                 ...
                 <input readonly type="text" name="usernameif_rs" class="form-control form-control-primary" id="usernameif_rs"  value="<?php echo "$row[usernameif_rs]";?>">
                    ...
                    <div class="col-sm-10">
                       <input readonly type="text" name="year_rs" class="form-control form-control-primary" id="year_rs" placeholder="พ.ศ." onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"/ maxlength="4"  value="<?php echo "$row[year_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
    <input readonly type="text" name="typepj_rs" class="form-control form-control-primary" id="typepj_rs"  value="<?php echo "$row[typepj_rs]";?>">                </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label icofont icofont-double-right">ชื่อโครงการวิจัย (ภาษาไทย)</label>
                    <div class="col-sm-10">
                       <input readonly  type="text" name="nameth_rs" class="form-control form-control-primary" id="nameth_rs" placeholder="ชื่อโครงการวิจัย/งานสร้างสรรค์(ภาษาไทย)" required value="<?php echo "$row[nameth_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <input readonly type="text" name="nameen_rs" class="form-control form-control-primary" id="nameen_rs" placeholder="ชื่อโครงการวิจัย/งานสร้างสรรค์(ภาษาอังกฤษ)" required value="<?php echo "$row[nameen_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
<input readonly type="text" name="typers_rs" class="form-control form-control-primary" id="typers_rs"  value="<?php echo "$row[typers_rs]";?>">                    </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label icofont icofont-double-right">วันเริ่มต้นโครงการ</label>
                    <div class="col-sm-10">
                        <input readonly type="text" name="dtstart_rs" class="form-control form-control-primary" id="dtstart_rs"   value="<?php echo "$row[dtstart_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                     <input readonly type="text" name="dtfinish_rs" class="form-control form-control-primary" id="dtfinish_rs"   value="<?php echo "$row[dtfinish_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                    <input readonly type="text" id="keyword_rs" class="form-control form-control-primary" placeholder="คำสำคัญ (keyword)" name="keyword_rs" required value="<?php echo "$row[keyword_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <input readonly type="text" id="sort_rs" class="form-control form-control-primary" placeholder=" " name="sort_rs" required value="<?php echo "$row[sort_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                      <input readonly type="text" id='det2' class="form-control form-control-primary"  name="rs_funding" id="rs_funding" value="<?php echo "$row[rs_funding]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
       <input readonly type="text" id='det4'  class="form-control form-control-primary" name="rs_fundingmoney" 
                    ...
                    <div class="col-sm-10">
                       <input readonly type="text" id='budget_rs' class="form-control form-control-primary" placeholder="งบประมาณโครงการวิจัย (บาท)" name="budget_rs" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"value="<?php echo "$row[budget_rs]";?> ">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <textarea readonly type="text" rows="4" class="form-control form-control-primary" placeholder="รายละเอียดเพิ่มเติม............." name="result_rs" id="result_rs"><?php echo "$row[result_rs]";?></textarea> 
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
<input readonly type="text"   class="form-control form-control-primary"  name="rs_funding" id="rs_funding" value="<?php echo "$row[ztilization_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
<input readonly type="text"   class="form-control form-control-primary"  name="ztilizationcmc_rs" id="ztilizationcmc_rs" value="<?php echo "$row[ztilizationcmc_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
<input readonly type="text"   class="form-control form-control-primary"  name="ztilizationsm_rs" id="ztilizationsm_rs" value="<?php echo "$row[ztilizationsm_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                       <textarea readonly type="text" rows="4" class="form-control form-control-primary" placeholder="" name="details_rs" id="details_rs"><?php echo "$row[details_rs]";?></textarea>
                    </div>
                    </div>
