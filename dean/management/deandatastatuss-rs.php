...
statusinformation_rs='$statusinformation_rs' where id ='$id'";



$result = mysqli_query($conn,$sql);//
echo "<script>alert('[บันทึกข้อมูลเรียบร้อย]')</script>";
echo "<script language='javascript'>window.location.href='/rs-cpu/dean/management/deandata-rs.php'</script>";
mysqli_close($conn);
}
?>