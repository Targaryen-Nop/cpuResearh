...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
          ...
          <?php $page='memberdbpbrs-rs'; include 'menu.php';  ?>
          

<div class="pcoded-content">                         
<form class="panel-body form-horizontal form-padding" name="reinfor" action="memberdbpbrs-rs.php" method ="post"enctype="multipart/form-data">                    
