...
<head>
    <title>CPU RESEARCH | ประกาศ</title>
    <meta charset="utf-8">
...
<?php $page='memberhome1-rs'; include 'menu.php';  ?>


<div class="pcoded-content">                         
<form class="panel-body form-horizontal form-padding" name="reinfor" action="memberhome1-rs.php" method ="post"enctype="multipart/form-data">                    
                    ...
                    <div class="sub-title">
                        ...
                        <tr>
                             ...
                             <th class="h6 mb-2 ">ประกาศ</th>                     
                             <th class="h6 mb-2 ">ไฟล์ประกาศ</th> 
                        </tr>
                        </thead>
                        <tbody>
                        <?php
