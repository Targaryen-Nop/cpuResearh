...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="memberpublishedits-rs.php" method ="post"enctype="multipart/form-data">                    
                ...
                <input type="hidden" name="id" class="form-control" id="id"  value="<?php echo "$row[id]";?>">
                 <input readonly type="text" name="idportfolio_rs" class="form-control form-control-primary" id="idportfolio_rs"  value="<?php echo "$row[idportfolio_rs]";?>">
                    </div>
                    </div> 
                ...
                <input type="text" name="yearpf_rs" id="yearpf_rs" class="form-control form-control-primary" placeholder="ผลงานวิจัยปี" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"/ maxlength="4"  value="<?php echo "$row[yearpf_rs]";?>">
                 ...
                 <input type="text" name="nameen_rs" class="form-control form-control-primary" id="nameen_rs" placeholder="ชื่องานวิจัย (ภาษาอังกฤษ)" value="<?php echo "$row[nameen_rs]";?>">
                    ...
                    <div class="col-sm-4">
           <input readonly type="text" name="researcher_rs" class="form-control form-control-primary" id="researcher_rs"  value="<?php echo "$row[researcher_rs]";?>">
                    </div>
                    </div> 
                    ...
                    <div class="col-sm-4">
                        <select placeholder="คณะ" class="btn btn-block btn-outline-primary btn-flat"  name="board_rs" id="board_rs" >
                    ...
                    <div class="col-sm-4">
                <select placeholder="หลักสูตร"   class="btn btn-block btn-outline-primary btn-flat"  name="subject_rs" id="subject_rs" >
...
<select  class="btn btn-block btn-outline-success btn-flat" onChange="chksatatus(this.value);" type="text" id="sort_rs" name="sort_rs">
                    ...
                    <div class="col-sm-10">
                 <input type="text" name="namejournal_rs" class="form-control form-control-success"   value="<?php echo "$row[namejournal_rs]";?>">
                    </div>
                    </div> 
                    ...
                    <div class="col-sm-2">
                  <input type="text" name="yearjournal_rs" class="form-control form-control-success"  onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"/maxlength="4" value="<?php echo "$row[yearjournal_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-2">
                 <input type="text" name="issuejournal_rs" class="form-control form-control-success"  value="<?php echo "$row[issuejournal_rs]";?>">
                    </div>
                    </div>
  ...
  <select class="btn btn-block btn-outline-success btn-flat" data-placeholder="เลือกเดือน..." type="text" name="monthjournal_rs" id="monthjournal_rs">    
                    ...
                    <div class="col-sm-2">
            <input type="text" name="pagejournal_rs" class="form-control form-control-success"  maxlength="8" value="<?php echo "$row[pagejournal_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                <input type="text" name="meeting_rs" class="form-control form-control-success" id=""   value="<?php echo "$row[meeting_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                <input type="text" name="typeat_rs" class="form-control form-control-success"  value="<?php echo "$row[typeat_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-4">
           <input type="text" name="province_rs" class="form-control form-control-success"  value="<?php echo "$row[province_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-2">
                <input type="text" name="year_rs" class="form-control form-control-success"   onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"/ maxlength="4" value="<?php echo "$row[year_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-2">
   <input type="text" id="page_rs" class="form-control form-control-success"   name="page_rs"  maxlength="8" value="<?php echo "$row[page_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-2">
            <input type="text" name="timeprint_rs" id="timeprint_rs" class="form-control form-control-success"  value="<?php echo "$row[timeprint_rs]";?>">
                    </div>
                    </div>
