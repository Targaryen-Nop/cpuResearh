...
<head>
    <title>CPU RESEARCH | ฐานข้อมูลโครงการวิจัย</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
          ...
          <?php $page='memberdbrs-rs'; include 'menu.php';  ?>
          
<div class="pcoded-content">                         
<form class="panel-body form-horizontal form-padding" name="reinfor" action="memberdbrs-rs.php" method ="post"enctype="multipart/form-data">                    
