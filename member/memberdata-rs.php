...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="memberdata-rs.php" method ="post"enctype="multipart/form-data">                    
...
<a class="dropdown-item waves-light waves-effect" href="/rs-cpu/member/memberdataedit-rs.php?id=<?php echo $row["id"];?>">แก้ไขข้อมูลโครงการวิจัย</a>
                    <div class="dropdown-divider"></div>
<a class="dropdown-item waves-light waves-effect" href="/rs-cpu/member/memberdatareporttrackingadd-rs.php?id=<?php echo $row["id"];?>">รายงานความคืบหน้าโครงการวิจัย</a>
                </div>
                </div>
                </div>            
           <?php        
           ...
           <!-- endTab 6 -->
            ...
            <table id="myTable3" class="display" style="width: 100%;">
                        ...
                        <?php
                             ...
                             $sql="SELECT*FROM rs_tracking where username_rs = '$_SESSION[username_rs]'";
                             $result=mysqli_query($conn,$sql);
                             while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
                        {?>
                <tr style="color:#000;">
 ...
 <a href="/rs-cpu/member/memberdatareporttracking-rs.php?id=<?php echo $row["id"];?>" class="btn btn-success btn-round waves-effect waves-light">ดูรายงาน</a></h3></td>
                    <?php
                    }?>
                        </tbody>
                        </table>
