...
<head>
    <title>CPU RESEARCH | แก้ไขข้อมูลส่วนตัว</title>
    <meta charset="utf-8">
...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="profileedits-rs.php" method ="post"enctype="multipart/form-data">                    
                ...
                <form>
                 ...
                 <input type="text" name="username_rs" class="form-control form-control-primary" id="username_rs" readonly value="<?php echo "$row[username_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-11">
                     <input type="text" name="password_rs" class="form-control form-control-primary" id="password_rs" value="<?php echo "$row[password_rs]";?>" maxlength="20">
                     </div>
                    </div>
                    ...
                    <div class="col-sm-11">
                          <select class="btn btn-block btn-outline-primary btn-flat" type="text" id="title_rs" name="title_rs"> 
                    ...
                    <div class="col-sm-11">
                   <input type="text" name="firstname_rs" class="form-control form-control-primary" id="firstname_rs" value="<?php echo "$row[firstname_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-11">
                      <input type="text" name="lastname_rs" class="form-control form-control-primary" id="lastname_rs" value="<?php echo "$row[lastname_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-11">
                           <select class="btn btn-block btn-outline-primary btn-flat" type="text" id="sex_rs" name="sex_rs"> 
                    ...
                    <div class="col-sm-11">
                        <select class="btn btn-block btn-outline-primary btn-flat" type="text" id="board_rs" name="board_rs"> 
                    ...
                    <div class="col-sm-11">
                        <select class="btn btn-block btn-outline-primary btn-flat" type="text" id="subject_rs" name="subject_rs"> 
 ...
 <option value="หลักสูตรปรัชญาดุษฎีบัณฑิต สาขาวิชาการบริหารการพัฒนาองค์การ">หลักสูตรปรัชญาดุษฎีบัณฑิต สาขาวิชาการบริหารการพัฒนาองค์การ</option>
                    ...
                    <div class="col-sm-11">
           <input type="email" name="email_rs" class="form-control form-control-primary" id="email_rs" value="<?php echo "$row[email_rs]";?>">
                    </div>
                    </div>
                    ...
                    <div class="col-sm-11">
          <input type="text" name="phone_rs" class="form-control form-control-primary" id="phone_rs" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" value="<?php echo "$row[phone_rs]";?>" maxlength="10">
                    </div>
                    </div>                 
