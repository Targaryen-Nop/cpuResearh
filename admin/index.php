                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li>
                                  <a href="map-google.html" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">ความก้าวหน้าโครงการวิจัย</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                               <li>
                                  <a href="map-google.html" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">รายงานประจำเดือน</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                               <li>
