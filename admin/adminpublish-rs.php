...
<head>
    <title>CPU RESEARCH | ฐานข้อมูลงานวิจัยที่เผยแพร่</title>
    <meta charset="utf-8">
...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="adminpublish-rs.php" method ="post"enctype="multipart/form-data">                    
                    ...
                    <div class="sub-title">
                       ...
                       <ul class="nav nav-tabs  tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active " data-toggle="tab" href="#tab1" role="tab">ข้อมูลงานวิจัยที่เผยแพร่</a>
                        </li>
           ...
           $sql="SELECT*FROM rs_portfolio where board_rs = 'คณะมนุษยศาสตร์และสังคมศาสตร์' and subject_rs = 'หลักสูตรศึกษาศาสตรมหาบัณฑิต สาขาวิชาการบริหารการศึกษา'";
                      ...
                      <div class="sub-title"></div>
                        ...
                        <tr>
                            ...
                            <th class="h6 mb-2 ">เลขงานวิจัยเผยแพร่</th>
...
<a class="dropdown-item waves-light waves-effect" href="/rs-cpu/admin/adminpublishedit-rs.php?id=<?php echo $row["id"];?>">แก้ไข</a>
           <div class="dropdown-divider"></div>
<a class="dropdown-item waves-light waves-effect" href="/rs-cpu/admin/deletepf-rs.php?id=<?php echo $row["id"];?>">ลบ</a>
           </div>
           </div>
           </div> 
                  <?php
