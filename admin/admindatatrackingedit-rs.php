...
<head>
    <title>CPU RESEARCH | อัพเดทความก้าวหน้างานวิจัย</title>
    <meta charset="utf-8">
...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="admindatatrackingedits-rs.php" method ="post"enctype="multipart/form-data">                    
                     <!-- Page-header end -->
                    ...
                    <div class="card-header">
                    <div class="sub-title">
                    <h5>อัพเดทความก้าวหน้างานวิจัย</h5>
                    <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                    </div>
                    <div class="card-block">
                    <div class="form-group row">
                    ...
                    <h4 align="center" class="h6 mb-2 text-gray-900" ><label><h3>อัพเดทสถานะโครงการวิจัย</h3></label></h4>           
                     </div>               
                    </div>
                    ...
                    <div class="col-sm-10">
                    <select placeholder="สถานะโครงการวิจัย" class="btn btn-block btn-outline-success btn-flat"  name="statusinformation_rs" id="statusinformation_rs" required>
                 <option value="<?php echo "$row[statusinformation_rs]";?>"><?php echo "$row[statusinformation_rs]";?></option>
                          <option value="อนุมัติโครงการ">อนุมัติโครงการ</option>
                    ...
                    <div class="col-md-12">
                    <div class="form-group">  
                    <h4 align="center" class="h6 mb-2 text-gray-900" ><label><h3>อัพเดทความก้าวหน้างานวิจัย</h3></label></h4>           
                     </div>               
                    </div>

                    <div class="form-group row">
                    <label class="col-sm-2 icofont icofont-double-right">บทที่ 1</label>
                    <div class="col-sm-10">
                    <select placeholder="บทที่ 1"  class="btn btn-block btn-outline-primary btn-flat"  name="term1_rs" id="term1_rs"  >
                          <option value="<?php echo "$row[term1_rs]";?>"><?php echo "$row[term1_rs]";?></option>
                          <option value=""></option>
                    ...
                    <div class="form-group row">
                    <label class="col-sm-2 icofont icofont-double-right">บทที่ 2</label>
                    <div class="col-sm-10">
                    <select placeholder="บทที่ 2"  class="btn btn-block btn-outline-primary"  name="term2_rs" id="term2_rs"  >
                          <option value="<?php echo "$row[term2_rs]";?>"><?php echo "$row[term2_rs]";?></option>
                          <option value=""></option>
                          <option value="อยู่ระหว่างดำเนินการ">อยู่ระหว่างดำเนินการ</option>
                          <option value="ยังไม่ได้ดำเนินการ">ยังไม่ได้ดำเนินการ</option>
                          <option value="แล้วเสร็จสมบรูณ์">แล้วเสร็จสมบรูณ์</option>
                    ...
                    <div class="form-group row">
                    <label class="col-sm-2 icofont icofont-double-right">บทที่ 3</label>
                    <div class="col-sm-10">
                    <select placeholder="บทที่ 3"  class="btn btn-block btn-outline-primary"  name="term3_rs" id="term3_rs"  >
                          <option value="<?php echo "$row[term3_rs]";?>"><?php echo "$row[term3_rs]";?></option>
                          <option value=""></option>
                          <option value="อยู่ระหว่างดำเนินการ">อยู่ระหว่างดำเนินการ</option>
                          <option value="ยังไม่ได้ดำเนินการ">ยังไม่ได้ดำเนินการ</option>
                          <option value="แล้วเสร็จสมบรูณ์">แล้วเสร็จสมบรูณ์</option>
                    ...
                    <div class="form-group row">
                    <label class="col-sm-2 icofont icofont-double-right">บทที่ 4</label>
                    <div class="col-sm-10">
                    <select placeholder="บทที่ 4"  class="btn btn-block btn-outline-primary"  name="term4_rs" id="term4_rs"  >
                          <option value="<?php echo "$row[term4_rs]";?>"><?php echo "$row[term4_rs]";?></option>
                          <option value=""></option>
                          <option value="อยู่ระหว่างดำเนินการ">อยู่ระหว่างดำเนินการ</option>
                          <option value="ยังไม่ได้ดำเนินการ">ยังไม่ได้ดำเนินการ</option>
                          <option value="แล้วเสร็จสมบรูณ์">แล้วเสร็จสมบรูณ์</option>
                    ...
                    <div class="form-group row">
                    <label class="col-sm-2 icofont icofont-double-right">บทที่ 5</label>
                    <div class="col-sm-10">
                    <select placeholder="บทที่ 5"  class="btn btn-block btn-outline-primary"  name="term5_rs" id="term5_rs"  >
                          <option value="<?php echo "$row[term5_rs]";?>"><?php echo "$row[term5_rs]";?></option>
                          <option value=""></option>
                          <option value="อยู่ระหว่างดำเนินการ">อยู่ระหว่างดำเนินการ</option>
                          <option value="ยังไม่ได้ดำเนินการ">ยังไม่ได้ดำเนินการ</option>
                          <option value="แล้วเสร็จสมบรูณ์">แล้วเสร็จสมบรูณ์</option>
