...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="admindataedits-rs.php" method ="post"enctype="multipart/form-data">                    
                ...
                <form>
                 ...
                 <input type="text" name="usernameif_rs" class="form-control form-control-primary" id="usernameif_rs"  value="<?php echo "$row[usernameif_rs]";?>">
                    </div>
                    </div>                    
