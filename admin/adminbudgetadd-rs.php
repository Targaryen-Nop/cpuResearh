...
$sql = "insert into rs_budget values ('null','$yearbg_rs','$mbudget_rs','$sbudget_rs','$hbudget_rs','0','0','0')";
...
<head>
    <title>CPU RESEARCH | เพิ่มงบประมาณโครงการวิจัยระดับคณะ</title>
    <meta charset="utf-8">
...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="adminbudgetadd-rs.php" method ="post"enctype="multipart/form-data">                    
     <!-- Page-header end -->
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                      <div class="sub-title">
                                                        <h5>เพิ่มงบประมาณโครงการวิจัยระดับคณะ</h5>
                    ...
                    <div class="col-sm-10">
                    <input type="text" name="yearbg_rs" class="form-control form-control-primary" id="yearbg_rs" placeholder="พ.ศ."onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"maxlength="4"/required >
                    </div>
                    </div> 
                    ...
                    <div class="col-sm-10">
                   <input type="text" id='mbudget_rs' class="form-control form-control-primary" placeholder="(บาท)" name="mbudget_rs" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"maxlength="8"/required >
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                    <input type="text" id='sbudget_rs' class="form-control form-control-primary" placeholder="(บาท)" name="sbudget_rs"onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"maxlength="8"/required > 
                    </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                    <input type="text" id='hbudget_rs' class="form-control form-control-primary" placeholder="(บาท)" name="hbudget_rs" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"maxlength="8"/required > 
                    </div>
                    </div>                   
