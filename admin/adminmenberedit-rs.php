...
<?php
    ...
    $sql="SELECT * FROM rs_user  where id='$id'" ;
...
<head>
    <title>CPU RESEARCH | แก้ไขข้อมูลสมาชิก</title>
    <meta charset="utf-8">
...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="adminmenberedits-rs.php" method ="post"enctype="multipart/form-data">                    
                ...
                <form>
                    ...
                    <div class="col-sm-11">
                        ...
                        <input type="text" class="form-control form-control-primary" placeholder="Username" name="username_rs" id="username_rs" maxlength="20" value="<?php echo "$row[username_rs]";?>" required>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-11">
                        <input type="text" class="form-control form-control-primary" placeholder="Password" name="password_rs" id="password_rs" maxlength="10" value="<?php echo "$row[password_rs]";?>" required>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-11">
                        <select input type="list" class="form-control"  name="title_rs" id="title_rs" placeholder="คำนำหน้า">
                          <option value="<?php echo "$row[title_rs]";?>"><?php echo "$row[title_rs]";?></option>
                    ...
                    <div class="col-sm-11">
                        <input type="text" class="form-control form-control-normal" placeholder="ชื่อ" name="firstname_rs" id="firstname_rs" onKeyUp="if(!(isNaN(this.value))) { alert('กรุณากรอกอักษร'); this.value='';}" value="<?php echo "$row[firstname_rs]";?>" required>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-11">
                        <input type="text" class="form-control form-control-normal" placeholder="นามสกุล" name="lastname_rs" id="lastname_rs" onKeyUp="if(!(isNaN(this.value))) { alert('กรุณากรอกอักษร'); this.value='';}" value="<?php echo "$row[lastname_rs]";?>" required>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-11">
                        <select placeholder="เพศ" input type="list" class="form-control"  name="sex_rs" id="sex_rs" required>
                              <option value="<?php echo "$row[sex_rs]";?>"><?php echo "$row[sex_rs]";?></option>
 ...
 <option value="หลักสูตรปรัชญาดุษฎีบัณฑิต สาขาวิชาการบริหารการพัฒนาองค์การ">หลักสูตรปรัชญาดุษฎีบัณฑิต สาขาวิชาการบริหารการพัฒนาองค์การ</option>
                    ...
                    <div class="col-sm-11">
                        <input type="email" class="form-control" placeholder="Email" name="email_rs" id="email_rs" value="<?php echo "$row[email_rs]";?>" required>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-11">
                        <input type="text" class="form-control form-control-normal" placeholder="เบอร์โทร" name="phone_rs" id="phone_rs" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"/  maxlength="10"  value="<?php echo "$row[phone_rs]";?>" >
                    </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-1 col-form-label icofont icofont-double-right">สถานะ</label>
                    <div class="col-sm-11">
                        <select placeholder="สถานะ"  class="form-control form-control-primary"  name="status_rs" id="status_rs" >
                              <option value="<?php echo "$row[status_rs]";?>"><?php echo "$row[status_rs]";?></option>
                              <option value="admin">admin</option>
                              <option value="member">menber</option>
