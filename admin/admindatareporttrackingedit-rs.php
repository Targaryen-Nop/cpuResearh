...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="admindatareporttrackingedits-rs.php" method ="post"enctype="multipart/form-data">                    
                     <!-- Page-header end -->
      ...
      <option value="<?php echo "$row[statusproject_rs]";?>"><?php echo "$row[statusproject_rs]";?></option>
                    ...
                    <div align="left" class="btn waves-effect waves-light btn-danger btn-outline-danger"><a href="../filetracking/<?php echo $row{"filetracking"};?>"><?php echo $row{"filetracking"};?></a></div></td> 
                    </div>
                    </div>
                    </div> 
               ...
               <div class="col-md-5">
                <div class="form-group">
                  <label class="h6 mb-2 text-gray-900">ผลการดำเนินงาน</label>
                    ...
                    <option value="<?php echo "$row[performance1_rs]";?>"><?php echo "$row[performance1_rs]";?></option>
                ...
                <textarea type="result_rs" rows="4" class="form-control form-control-primary" placeholder=" " name="barriers1_rs" id="barriers1_rs"><?php echo "$row[barriers1_rs]";?></textarea>
                </div>               
                </div>
               ...
               <textarea type="result_rs" rows="4" class="form-control form-control-primary" placeholder=" " name="help1_rs" id="help1_rs"><?php echo "$row[help1_rs]";?></textarea>
                </div>               
                </div>
               ...
               <div class="col-md-5">
                ...
                <option value="<?php echo "$row[performance2_rs]";?>"><?php echo "$row[performance2_rs]";?></option>
                          <option value="แล้วเสร็จสมบรูณ์">แล้วเสร็จสมบรูณ์</option>
                          <option value="อยู่ระหว่างดำเนินการ">อยู่ระหว่างดำเนินการ</option>
                          <option value="ยังไม่ได้ดำเนินการ">ยังไม่ได้ดำเนินการ</option>
                          </select>
                ...
                <div class="form-group"> 
                <label class="h6 mb-2 text-gray-900">ปัญหาและอุปสรรค์ในการดำเนินงาน</label>  
               <textarea type="result_rs" rows="4" class="form-control form-control-primary" placeholder=" " name="barriers2_rs" id="barriers2_rs"><?php echo "$row[barriers2_rs]";?></textarea>
                </div>               
                </div>
                ...
                <div class="form-group"> 
                <label class="h6 mb-2 text-gray-900">ความช่วยเหลือที่ต้องการ</label>  
               <textarea type="result_rs" rows="4" class="form-control form-control-primary" placeholder=" " name="help2_rs" id="help2_rs"><?php echo "$row[help2_rs]";?></textarea>
                </div>               
                </div>
                ...
                <div class="form-group">
                  <label class="h6 mb-2 text-gray-900">ผลการดำเนินงาน</label>
                      <select class="btn btn-block btn-outline-success btn-flat" onChange="chksatatus(this.value);" type="text" name="performance3_rs" id="performance3_rs">
                        <option value="<?php echo "$row[performance3_rs]";?>"><?php echo "$row[performance3_rs]";?></option>
                          <option value="แล้วเสร็จสมบรูณ์">แล้วเสร็จสมบรูณ์</option>
                          <option value="อยู่ระหว่างดำเนินการ">อยู่ระหว่างดำเนินการ</option>
                          <option value="ยังไม่ได้ดำเนินการ">ยังไม่ได้ดำเนินการ</option>
                          </select>
                ...
                <div class="form-group"> 
                <label class="h6 mb-2 text-gray-900">ปัญหาและอุปสรรค์ในการดำเนินงาน</label>  
               <textarea type="result_rs" rows="4" class="form-control form-control-primary" placeholder=" " name="barriers3_rs" id="barriers3_rs"><?php echo "$row[barriers3_rs]";?></textarea>
                </div>               
                </div>
                ...
                <div class="form-group"> 
                <label class="h6 mb-2 text-gray-900">ความช่วยเหลือที่ต้องการ</label>  
               <textarea type="result_rs" rows="4" class="form-control form-control-primary" placeholder=" " name="help3_rs" id="help3_rs"><?php echo "$row[help3_rs]";?></textarea>
                </div>               
                </div>
               ...
               <div class="col-md-5">
                <div class="form-group">
                  <label class="h6 mb-2 text-gray-900">ผลการดำเนินงาน</label>
                      <select class="btn btn-block btn-outline-success btn-flat" onChange="chksatatus(this.value);" type="text" name="performance4_rs" id="performance4_rs">
                        <option value="<?php echo "$row[performance4_rs]";?>"><?php echo "$row[performance4_rs]";?></option>
                          <option value="แล้วเสร็จสมบรูณ์">แล้วเสร็จสมบรูณ์</option>
                          <option value="อยู่ระหว่างดำเนินการ">อยู่ระหว่างดำเนินการ</option>
                          <option value="ยังไม่ได้ดำเนินการ">ยังไม่ได้ดำเนินการ</option>
                          </select>
                ...
                <div class="form-group"> 
                <label class="h6 mb-2 text-gray-900">ปัญหาและอุปสรรค์ในการดำเนินงาน</label>  
            <textarea type="result_rs" rows="4" class="form-control form-control-primary" placeholder=" " name="barriers4_rs" id="barriers4_rs"><?php echo "$row[barriers4_rs]";?></textarea>
                </div>               
                </div>
                ...
                <div class="form-group"> 
                <label class="h6 mb-2 text-gray-900">ความช่วยเหลือที่ต้องการ</label>  
                <textarea ttype="result_rs" rows="4" class="form-control form-control-primary" placeholder=" " name="help4_rs" id="help4_rs"><?php echo "$row[help4_rs]";?></textarea>
                </div>               
                </div>
               ...
               <div class="col-md-5">
                <div class="form-group">
                  <label class="h6 mb-2 text-gray-900">ผลการดำเนินงาน</label>
                      <select class="btn btn-block btn-outline-success btn-flat" onChange="chksatatus(this.value);" type="text" name="performance5_rs" id="performance5_rs">
                        <option value="<?php echo "$row[performance5_rs]";?>"><?php echo "$row[performance5_rs]";?></option>
                          <option value="แล้วเสร็จสมบรูณ์">แล้วเสร็จสมบรูณ์</option>
                          <option value="อยู่ระหว่างดำเนินการ">อยู่ระหว่างดำเนินการ</option>
                          <option value="ยังไม่ได้ดำเนินการ">ยังไม่ได้ดำเนินการ</option>
                          </select>
                ...
                <div class="form-group"> 
                <label class="h6 mb-2 text-gray-900">ปัญหาและอุปสรรค์ในการดำเนินงาน</label>  
               <textarea type="result_rs" rows="4" class="form-control form-control-primary" placeholder="" name="barriers5_rs" id="barriers5_rs"><?php echo "$row[barriers5_rs]";?></textarea>
                </div>               
                </div>
                ...
                <div class="form-group"> 
                <label class="h6 mb-2 text-gray-900">ความช่วยเหลือที่ต้องการ</label>  
                <textarea type="result_rs" rows="4" class="form-control form-control-primary" placeholder="" name="help5_rs" id="help5_rs"><?php echo "$row[help5_rs]";?></textarea>
                </div>               
                </div>
