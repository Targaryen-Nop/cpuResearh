...
$sql = "insert into rs_home values ('null','$namefrom_rs','".$_FILES["fileToUpload"]["name"]."')";
...
<form class="panel-body form-horizontal form-padding" name="reinfor" action="adminhome-rs.php" method ="post"enctype="multipart/form-data">                    
                    ...
                    <div class="sub-title">
                        ...
                        <ul class="nav nav-tabs  tabs" role="tablist">
                            <li class="nav-item">
                            <a class="nav-link active " data-toggle="tab" href="#home1" role="tab">ฟอร์มเอกสารดาวน์โหลด</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#profile1" role="tab">จัดการแบบฟอร์มดาวโหลด</a>
                        </li>
                        </ul>
   ...
   <a href="/rs-cpu/admin/delete-rs.php?id=<?php echo $row["id"];?>"class="btn btn-danger btn-round waves-effect waves-light" >ลบ</a></h3></td>    
            ...
            <label class="h6 mb-2 ">ชื่อแบบฟอร์ม</label>
            <input type="text" name="namefrom_rs" class="form-control" id="namefrom_rs" placeholder="ชื่อแบบฟอร์ม"   required>
            </div>
            </div>      
            ...
            <h3 align="center">
            <button type="submit" class="btn btn-primary btn-round waves-effect waves-light">บันทึก</button> 
